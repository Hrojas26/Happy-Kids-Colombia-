    ...
    <div class="container">
        <div class="row info-user">
            ...
            <div class="row info-user">
                ...
                <ol>
                    <li>
                        <p class="mb-0 mb-3"> <strong>En camino a la magia:</strong> Hemos coordinado la recogida y pronto pasarán a buscar esas preciosas donaciones que traerán alegría a muchos niños. Gracias por hacer magia posible desde tu hogar.</p>
                    </li>
                    <li>
